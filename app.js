  ...
  state.charts['chart-line'] = new Chart(ctx, {
    ...
    options: {
      ...
      scales: {
        x: {
          grid: { color: '#FDF2F8' },
          ticks: { font: { family: 'Poppins', size: 10 }, color: '#C4859E' }
        },
        y: {
          min: 0, max: 10,
          grid: { color: '#FDF2F8' },
          ticks: { font: { family: 'Poppins', size: 10 }, color: '#C4859E', stepSize: 2 }
        }
      }
    }
  });
    ...
    options: {
      ...
      scales: {
        r: {
          ...
          pointLabels: { font: { family: 'Poppins', size: 11 }, color: '#9D174D' }
        }
      }
    }
  });
